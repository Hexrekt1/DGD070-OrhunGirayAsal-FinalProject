...
public partial class GameEntity {
    ...
    public void AddPad(bool newTouched, UnityEngine.Color newColor) {
        var index = GameComponentsLookup.Pad;
        var component = (PadComponent)CreateComponent(index, typeof(PadComponent));
        component.touched = newTouched;
        component.color = newColor;
        AddComponent(index, component);
    }

    public void ReplacePad(bool newTouched, UnityEngine.Color newColor) {
        var index = GameComponentsLookup.Pad;
        var component = (PadComponent)CreateComponent(index, typeof(PadComponent));
        component.touched = newTouched;
        component.color = newColor;
