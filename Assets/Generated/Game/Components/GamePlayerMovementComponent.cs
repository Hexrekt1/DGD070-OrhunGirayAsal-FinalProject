...
public partial class GameEntity {
    ...
    public void AddPlayerMovement(float newSpeed, UnityEngine.Vector2 newDirection) {
    ...
    public void ReplacePlayerMovement(float newSpeed, UnityEngine.Vector2 newDirection) {
        var index = GameComponentsLookup.PlayerMovement;
        var component = (PlayerMovementComponent)CreateComponent(index, typeof(PlayerMovementComponent));
        component.speed = newSpeed;
        component.direction = newDirection;
