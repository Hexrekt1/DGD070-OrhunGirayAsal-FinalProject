...
public partial class GameEntity {
    ...
    public void AddInput(bool newMoveUp, bool newMoveDown, bool newMoveLeft, bool newMoveRight) {
        var index = GameComponentsLookup.Input;
        var component = (InputComponent)CreateComponent(index, typeof(InputComponent));
        component.moveUp = newMoveUp;
        component.moveDown = newMoveDown;
        component.moveLeft = newMoveLeft;
        component.moveRight = newMoveRight;
        AddComponent(index, component);
    }

    public void ReplaceInput(bool newMoveUp, bool newMoveDown, bool newMoveLeft, bool newMoveRight) {
        var index = GameComponentsLookup.Input;
        var component = (InputComponent)CreateComponent(index, typeof(InputComponent));
        component.moveUp = newMoveUp;
        component.moveDown = newMoveDown;
